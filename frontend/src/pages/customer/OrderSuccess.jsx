...
const OrderSuccess = () => (
  <div className="flex flex-col items-center justify-center min-h-[75vh] text-center px-4 animate-fade-in">
    ...
    <div className="flex flex-col sm:flex-row gap-3">
      <Link to="/dashboard" className="flex items-center gap-2 px-6 py-3 rounded-xl bg-blue-900 hover:bg-blue-800 text-white font-semibold text-sm transition-colors shadow-lg shadow-blue-900/20">
        <Package className="h-4 w-4" /> Track Orders
      </Link>
      <Link to="/products" className="flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-300 font-semibold text-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
